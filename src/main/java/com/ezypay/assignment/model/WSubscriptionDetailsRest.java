...
public class WSubscriptionDetailsRest implements Serializable {
    ...
    public WSubscriptionDetailsRest() {
    }

    public WSubscriptionDetailsRest(double amount, WSubscriptionType wSubscriptionType, WSubscriptionDate wSubscriptionDate) {
        this.amount = amount;
