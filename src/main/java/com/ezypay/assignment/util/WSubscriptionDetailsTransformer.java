...
public class WSubscriptionDetailsTransformer implements Function<WSubscriptionDetails, SubscriptionDetails> {
    ...
    @Override
    public SubscriptionDetails apply(WSubscriptionDetails wSubscriptionDetails) {
